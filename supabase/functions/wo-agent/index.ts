...
// WO-0742: createFailureRemediation REMOVED — replaced by outbox spawn_remediation effect.
// SQL build_remediation_objective() assembles all remediation context.
// Call sites now use wo_transition('mark_failed') which triggers spawn_remediation via outbox.
