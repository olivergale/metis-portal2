...
const TIMEOUT_MS = 350_000; // 350s â 50s buffer before 400s Supabase Pro wall clock limit
const CHECKPOINT_MS = 300_000; // 300s â checkpoint before timeout to enable continuation
