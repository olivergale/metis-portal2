...
const GITHUB_TOOLS = ["github_read_file", "github_write_file", "github_edit_file", "github_patch_file", "github_list_files", "github_create_branch", "github_create_pr", "github_search_code"];
